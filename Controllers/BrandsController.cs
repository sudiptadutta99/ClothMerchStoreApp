...
namespace ClothMerchStoreApp.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "BrandID,BrandName")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "BrandID,BrandName")] Brand brand)
        {
            if (ModelState.IsValid)
            {
