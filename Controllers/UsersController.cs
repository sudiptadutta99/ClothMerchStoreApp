...
namespace ClothMerchStoreApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserID,FullName,Email,Password,Phone,DateRegistered")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserID,FullName,Email,Password,Phone,DateRegistered")] User user)
        {
            if (ModelState.IsValid)
            {
