...
namespace ClothMerchStoreApp.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "PaymentID,OrderID,PaymentMethod,PaymentStatus,PaymentDate")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PaymentID,OrderID,PaymentMethod,PaymentStatus,PaymentDate")] Payment payment)
        {
            if (ModelState.IsValid)
            {
